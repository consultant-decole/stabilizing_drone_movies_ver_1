...
\[vidstab](https://adamspannbauer.github.io/python\_video\_stab/html/index.html)
...
\* \*\*設定の特徴:\*\* \* `pad\_filter`: 画面サイズをあらかじめ\*\*1.5倍に拡張\*\*して解析します。
...
\* \*\*入力ディレクトリ\*\*: INPUT\_DIR = "ここに入力動画保存先パス"

\* \*\*出力ディレクトリ\*\*: OUTPUT\_DIR = "ここに出力動画の保存先"



\## 5. 実行サンプル

途中のglobal\_\*.mp4のファイルの出力は省略しています。
