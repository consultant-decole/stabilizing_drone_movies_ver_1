...
\* \[vidstab Documentation](https://adamspannbauer.github.io/python\_video\_stab/html/index.html)

\* \[vidstab on GitHub](https://github.com/AdamSpannbauer/python\_video\_stab)
...
\* \*\*Output:\*\* Generates an intermediate file: `global\_\*.mp4`.
...
\* \*\*INPUT\_DIR\*\*: Path to the folder containing your source videos.

\* \*\*OUTPUT\_DIR\*\*: Path where the processed videos will be saved.



\## 5. Execution Samples

\*Note: Intermediate `global\_\*.mp4` files are omitted for brevity.\*
